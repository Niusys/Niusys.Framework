...
namespace Niusys.Extensions.DynamicCodeAuthenticator
{
    ...
    public interface IUserDynamicCodeTokenProvider<TUser>
        where TUser : IDynamicCodeUser
    {
        ...
        /// for the same user.
        /// 
        /// Implementations of <see cref="IUserDynamicCodeTokenProvider{TUser}"/> should validate that purpose is not null or empty to
        ...
        /// </returns>
        Task<bool> CanGenerateDynamicCodeTokenAsync(IUserManager<TUser> manager, TUser user);
    }
}
