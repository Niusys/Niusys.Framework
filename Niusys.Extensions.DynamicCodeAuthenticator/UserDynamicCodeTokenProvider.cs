...
namespace Niusys.Extensions.DynamicCodeAuthenticator
{
    ...
    /// </summary>
    public class UserDynamicCodeTokenProvider<TUser> : IUserDynamicCodeTokenProvider<TUser>
        where TUser : IDynamicCodeUser
    {
        ...
        public async virtual Task<bool> CanGenerateDynamicCodeTokenAsync(IUserManager<TUser> manager, TUser user)
        {
