...
namespace Niusys.Extensions.AspNetCore.SpaServices.VueCli
{
    ...
    {
        private const string LogCategoryName = "VData.SpaServices";
        ...
        private static async Task<VueCliServerInfo> StartAngularCliServerAsync(string sourcePath, string npmScriptName, ILogger logger)
        {
            ...
            var serverInfo = new VueCliServerInfo { Port = uri.Port, PublicPath = uri.AbsolutePath.TrimEnd('/') };
